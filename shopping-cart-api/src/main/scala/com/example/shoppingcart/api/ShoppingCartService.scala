...
trait ShoppingCartService extends Service {
  ...
  def getItemCount(id: String): ServiceCall[NotUsed, ItemCount]
  /**
  ...
  def removeAll(id: String): ServiceCall[NotUsed, ShoppingCartView]
  ...
  final override def descriptor = {
    ...
    named("shopping-cart")
      .withCalls(
        ...
        restCall(Method.GET, "/shoppingcart/:id/count", getItemCount _),
        ...
        restCall(Method.DELETE, "/shoppingcart/:id", removeAll _),
...
final case class ItemCount(totalItems: Int)

object ItemCount {
  implicit val format: Format[ItemCount] = Json.format
}
/**
 * A shopping cart.
 *
